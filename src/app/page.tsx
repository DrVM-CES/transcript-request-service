  ...
  return (
    <div className="space-y-16">
      ...
      <div className="text-center py-12">
        ...
        <Link 
          href="/request" 
          className="inline-flex items-center px-8 py-4 text-lg font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-all shadow-lg hover:shadow-xl transform hover:scale-105"
        >
          Start Your Request
      ...
      <div className="bg-gradient-to-br from-slate-50 to-white rounded-2xl p-12 border border-slate-200">
        ...
        <div className="space-y-8 max-w-2xl mx-auto">
          ...
          <div className="flex items-start gap-6">
            <div className="w-12 h-12 bg-green-600 text-white rounded-xl flex items-center justify-center text-xl font-bold flex-shrink-0">
              ✓
            </div>
            <div>
      ...
      <div className="bg-blue-50 border-l-4 border-blue-600 rounded-r-xl p-6">
        <h4 className="text-lg font-bold text-blue-900 mb-4">Important Information</h4>
        <ul className="space-y-2 text-blue-800">
          ...
          <li className="flex items-start gap-2">
            ...
            <span>You will need your destination institution's CEEB code</span>
          </li>
        </ul>
      </div>
      ...
      <div className="text-center py-8">
        <Link 
          href="/request" 
          className="inline-flex items-center px-10 py-5 text-xl font-semibold text-white bg-blue-600 rounded-xl hover:bg-blue-700 transition-all shadow-lg hover:shadow-xl transform hover:scale-105"
        >
          Get Started Now
