    ...
    <div className="space-y-16">
      ...
      <div className="text-center py-12">
        ...
        <p className="text-xl text-slate-600 max-w-3xl mx-auto mb-10 leading-relaxed">
          Learn how to request your high school transcript for a college or university.
          Request intake is currently limited. Check availability before entering personal information.
        </p>
        <Link 
          href="/request" 
        ...
        <p className="text-sm text-slate-500 mt-4">
          A request receipt does not confirm transcript delivery.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-8">
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200 text-center hover:shadow-lg transition-all">
          ...
          <h3 className="text-xl font-bold text-slate-900 mb-3">Review Your Consent</h3>
          <p className="text-slate-600 leading-relaxed">
            Review the release disclosure and consent information before submitting a request.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200 text-center hover:shadow-lg transition-all">
          ...
          <h3 className="text-xl font-bold text-slate-900 mb-3">Prepare School Details</h3>
          <p className="text-slate-600 leading-relaxed">
            Have your school information and intended receiving institution ready.
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200 text-center hover:shadow-lg transition-all">
          ...
          <h3 className="text-xl font-bold text-slate-900 mb-3">Delivery Requires Confirmation</h3>
          <p className="text-slate-600 leading-relaxed">
            Submitting a request does not guarantee processing, delivery, or a completion date.
          </p>
        </div>
      </div>

      {/* When Request Intake Is Available */}
      <div className="bg-gradient-to-br from-slate-50 to-white rounded-2xl p-12 border border-slate-200">
        <h2 className="text-3xl font-bold text-slate-900 text-center mb-12">When Request Intake Is Available</h2>
        <div className="space-y-8 max-w-2xl mx-auto">
          ...
          <div className="flex items-start gap-6">
            ...
            <div>
              ...
              <p className="text-slate-600">If submission is available, review the result to see whether your request was received or needs further attention.</p>
            </div>
          </div>
          <div className="flex items-start gap-6">
            ...
            <div>
              <h4 className="text-lg font-bold text-slate-900 mb-2">Review the Request Receipt</h4>
              <p className="text-slate-600">Keep your request reference. Receipt of a request does not mean a transcript has been sent or received.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-mfc-primary-50 border-l-4 border-mfc-primary-500 rounded-r-xl p-6">
        ...
        <ul className="space-y-2 text-slate-700">
          ...
          <li className="flex items-start gap-2">
            ...
            <span>Delivery availability must be confirmed separately; this page does not confirm a connection to a transcript provider.</span>
          </li>
          <li className="flex items-start gap-2">
            <svg className="w-5 h-5 text-mfc-primary-500 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
            </svg>
            <span>Check school and destination details carefully before submitting a request.</span>
          </li>
        </ul>
      </div>
